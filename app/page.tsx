...
export default function Home() {
  ...
  return (
    <div className="grid grid-rows-[20px_1fr_20px] items-center justify-items-center min-h-screen p-8 pb-20 gap-16 sm:p-20 font-[family-name:var(--font-geist-sans)] bg-zinc-950">
      <h1 className="bg-orange-600 w-full text-3xl font-bold text-center py-6 text-white rounded-xl shadow-lg">
      ...
      <p className="text-center text-gray-500">
      New user? <a href="#" className="text-blue-500 hover:underline">Sign up here</a>.
      </p> 
    </div>
  );
}
